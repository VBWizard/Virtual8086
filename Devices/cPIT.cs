...
namespace VirtualProcessor.Devices
{
    ...
    public class cPIT : cDevice, iDevice
    {
        ...
        public cPIT(cDeviceBlock DevBlock)
        {
            mParent = DevBlock;
            ...
            //{
                ...
                if (time_passed > 0 || (s.last_next_event_time != s.timer.get_next_event_time()))
                {
                    ...
                    if (s.timer.get_next_event_time() > 0)
                    {
                        ...
                        mPICTimers[0].Interval = BX_MAX(1, (int)TICKS_TO_USEC(s.timer.get_next_event_time())) + mParent.mProc.mTimerTickMSec;
        ...
        bool periodic(Bit32u usec_delta)
        {
            ...
            ticks_delta = (Bit32u)((USEC_TO_TICKS((Bit64u)(s.total_usec))) - s.total_ticks);
        ...
        public override void InitDevice()
        {
            ...
            //if (s.timer_handle[0] == BX_NULL_TIMER_HANDLE) {
            //  s.timer_handle[0] = bx_virt_timer.register_timer(this, timer_handler, (unsigned) 100 , 1, 1, "pit_wrap");
            //}
            //BX_DEBUG(("RESETting timer."));
            //bx_virt_timer.deactivate_timer(s.timer_handle[0]);
            //BX_DEBUG(("deactivated timer."));
        ...
        public void Handle_IN(sPortValue IO)
        {
            ...
            switch (IO.Portnum)
            {
                ...
                case 0x61:
                    /* AT, port 61h */
                    s.refresh_clock_div2 = (bx_bool)(((my_time_usec / 15) & 1) == 1);
