...
namespace VirtualProcessor.Devices
{
    public class cDMA : cDevice, iDevice
    {
        ...
        public void DRQ(byte channel, bool val)
        {
            ...
            dma_roof = (DWord)(dma_base + s.chan[channel].base_count);
        ...
        {
            {
                ...
                switch (IO.Portnum)
                {
                    ...
                    case 0x08: // DMA-1 Status Register
                        ...
                        s.status_reg &= 0xf0;
                        lock (mParent.mProc.ports.mPorts)
                            mParent.mProc.ports.mPorts[0x08] = (byte)(retval);
                        break;
                    ...
                    case 0x0087: // DMA-1 page register, channel 0
                        ...
                        lock (mParent.mProc.ports.mPorts)
                            mParent.mProc.ports.mPorts[0x87] = (byte)(s.chan[channel].page_reg);
                        return;
                    case 0x0084: // ???
                        return;
