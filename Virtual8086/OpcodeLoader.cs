...
namespace VirtualProcessor
{
    public class OpcodeLoader
    {
        ...
        public void AddOpCodesToInstructionList(ref InstructionList<Instruct> Instrs, ref sOpCodePointer[] OpCodeIndexer)
        {
            int lConvertTo = 16;
            foreach (DataRow dr in tbl.Rows)
            {
                sOpCode oc = new sOpCode();
                System.Diagnostics.Debug.WriteLine(dr["Instruction"].ToString());
