...
namespace VirtualProcessor
{
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.regs.setFlagCF_ADC(lPreVal1.OpByte, lOp1ValUnsigned.OpByte, Op2Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    ...
                    mProc.regs.setFlagCF_ADC(lPreVal1.OpWord, lOp1ValUnsigned.OpWord, Op2Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    ...
                    mProc.regs.setFlagCF_ADC(lPreVal1.OpDWord, lOp1ValUnsigned.OpDWord, Op2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    ...
                    mProc.regs.setFlagCF_ADC(lPreVal1.OpQWord, lOp1ValUnsigned.OpQWord, Op2Value.OpQWord);
                    break;
            }
    ...
    public class BT : Instruct
    {
        ...
        {
            byte lDivisor = 0;
            if (Op1Add >= Processor_80x86.REGADDRBASE)
            {
                if (Op2TypeCode == TypeCode.UInt16)
                {
                    lDivisor = (byte)(Op2Value.OpWord % 16);
                    mProc.regs.setFlagCF(Misc.GetBits3(Op1Value.OpWord, lDivisor, 1) == 1);
                }
                else
                {
                    lDivisor = (byte)(Op2Value.OpDWord % 32);
                    mProc.regs.setFlagCF(Misc.GetBits3(Op1Value.OpDWord, lDivisor, 1) == 1);
                }
            }
            else
            {
    ...
    public class BTC : Instruct
    {
        ...
        public override void Impl()
        {
            byte lTheByte, lTheBit, lDivisor;
            ...
            if (Op1Add >= Processor_80x86.REGADDRBASE)
            {
                ...
                {
                    lDivisor = (byte)(Op2Value.OpWord % 16);
                    lTheBit = Misc.GetBits3(Op1Value.OpWord, lDivisor, 1);
                    mProc.regs.setFlagCF(lTheBit == 1);
                    if (lTheBit == 0)
                        lOp1Val.OpWord = Misc.setBit(Op1Value.OpWord, lDivisor, true);
                    else
                        lOp1Val.OpWord = Misc.setBit(Op1Value.OpWord, lDivisor, false);
                    mProc.mem.SetWord(mProc, Op1Add, lOp1Val.OpWord);
                }
                else
                {
                    lDivisor = (byte)(Op2Value.OpDWord % 32);
                    lTheBit = Misc.GetBits3(Op1Value.OpDWord, lDivisor, 1);
                    mProc.regs.setFlagCF(lTheBit == 1);
                    if (lTheBit == 0)
                        lOp1Val.OpDWord = Misc.setBit(Op1Value.OpDWord, lDivisor, true);
                    else
                        lOp1Val.OpDWord = Misc.setBit(Op1Value.OpDWord, lDivisor, false);
        ...
        public override void Impl()
        {
            ...
            switch (ChosenOpCode.OpCode)
            {
                ...
                default:
                    ...
                    {
                        mProc.mem.SetDWord(mProc, Processor_80x86.RCS, PhysicalMem.GetSegForLoc(mProc, Op1Value.OpDWord));
    ...
    public class CALLF : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (mProc.ProtectedModeActive)
            {
                ...
                {
                    mProc.mem.SetDWord(mProc, Processor_80x86.RCS, (DWord)(Op1Value.OpQWord >> 32) & 0xFFFF);
                    mProc.regs.EIP = mProc.mem.GetDWord(mProc, Op1Add);
                }
            }
            else
            {
                mProc.mem.SetDWord(mProc, Processor_80x86.RCS, Op1Value.OpDWord >> 0x10);
                mProc.regs.EIP = mProc.mem.GetWord(mProc, Op1Add);
            }
            #region Instructions
            #endregion
        ...
        public override void Impl()
        {
            if (lOpSize16)
            {
                ...
                if (Misc.getBit(mProc.regs.AX, 15) == 1)
                    //Replace 0xFFFF << 16 with 0xFFFF0000 | 
                    mProc.regs.EAX = (DWord)(0xFFFF0000 | mProc.regs.AX);
                else
...
Instruct lMov = mProc.Instructions["MOV"];
    ...
    public class CMP : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    lOp1ValSigned.OpByte -= lOp2Value.OpByte;
                    mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpByte, lOp1ValSigned.OpByte, Op2Value.OpByte);
                    mProc.regs.setFlagOF_Sub(lPreVal1.OpByte, lOp1ValSigned.OpByte, Op2Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1ValSigned.OpWord -= lOp2Value.OpWord;
                    mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpWord, lOp1ValSigned.OpWord, Op2Value.OpWord);
                    mProc.regs.setFlagOF_Sub(lPreVal1.OpWord, lOp1ValSigned.OpWord, Op2Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    lOp1ValSigned.OpDWord -= lOp2Value.OpDWord;
                    mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpDWord, lOp1ValSigned.OpDWord, Op2Value.OpDWord);
                    mProc.regs.setFlagOF_Sub(lPreVal1.OpDWord, lOp1ValSigned.OpDWord, Op2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1ValSigned.OpQWord -= lOp2Value.OpQWord;
                    mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpQWord, lOp1ValSigned.OpQWord, Op2Value.OpQWord);
                    mProc.regs.setFlagOF_Sub(lPreVal1.OpQWord, lOp1ValSigned.OpQWord, Op2Value.OpQWord);
                    break;
            }
            ...
            //SetC the flags
            SetFlagsForSubtraction(mProc, lPreVal1, lOp2Value, lOp1ValSigned, Op1TypeCode, true);
        }
    }
    public class CMPSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            DWord lLoopCounter = lAddrSize16 ? mProc.regs.CX : mProc.regs.ECX;
            ...
            MOVSW.SetupMOVSSrcDest(mProc, ref lSource, ref lDest, lAddrSize16);
            Value1.OpByte = mProc.mem.GetByte(mProc, lSource);
            if (PageFaultException) return; 
            ...
            SetFlagsForSubtraction(mProc, lPreVal1, Value2, Value1, TypeCode.Byte, true);
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpByte, Value1.OpByte, Value2.OpByte);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpByte, Value1.OpByte, Value2.OpByte);
            #region Instructions
            /*
            Operation
            temp ?SRC1 ? SRC2;
    ...
    public class CMPSW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.regs.setFlagOF_Sub(lPreVal1.OpWord, Value1.OpWord, Value2.OpWord);
            SetFlagsForSubtraction(mProc, lPreVal1, Value2, Value1, TypeCode.UInt16, true);
            #region Instructions
            /*
            Operation
            temp ?SRC1 ? SRC2;
    ...
    public class CMPSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.regs.setFlagOF_Sub(lPreVal1.OpDWord, Value1.OpDWord, Value2.OpDWord);
            SetFlagsForSubtraction(mProc, lPreVal1, Value2, Value1, TypeCode.UInt32, true);
            #region Instructions
            /*
            Operation
            temp ?SRC1 ? SRC2;
        ...
        public override void Impl()
        {
            switch (mProc.regs.EAX)
            {
                ...
                case 0x01:
                    ...
                    mProc.regs.EDX = 0x2010; //Only PSE, VM(E) and FPU enabled (add pge)
                                             //CLR 06/29/2013 - removed 1 for FPU
                    break;
                case 0x80000000:
                    mProc.regs.EAX = 0x18;
                    mProc.regs.EBX = 0x68747541;
    ...
    */
    ...
    public class DAS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if ((mProc.regs.AL & 0xF) > 0x9 || (Misc.getBit(mProc.regs.FLAGS, (int)eFLAGS.AF) == 1))
            {
                ...
                //06/27/2013 - FIX ME!!! mProc.regs.setFlagCF(lALBefore, mProc.regs.AL, 0x6);
        ...
        public override void Impl()
        {
            ...
            if (lOp2Value.OpByte > 0)
            {
                for (int c = 1; c < lOp2Value.OpByte - 1; c++)
                {
                    ...
                    {
                        if (!lAddrSize16) //32 bit address size
                        {
                            mProc.regs.EBP -= 4;
                            lPush.Op1Add = Processor_80x86.REBP;
                            lPush.Op1Value.OpDWord = mProc.regs.EBP;
    ...
    public class FCMOV : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                if (mProc.regs.FLAGSB.CF)
                    mProc.mFPU.DataReg[0] = mProc.mFPU.DataReg[DecodedInstruction.OpCode - 0xDAC0];
                return;
            }
    ...
    */
    ...
    public class FNOP : Instruct
    {
        public FNOP()
        {
            ...
            mProcPentium = true;
            mProcPentiumPro = true;
            mDescription = "FPU: No Operation";
            mModFlags = 0;
            FPUInstruction = true;
        }
        public override void Impl()
        {
            mProc.regs.EAX = mProc.regs.EAX;
            #region Instructions
            /*
    */
            #endregion
    ...
    */
    ...
    public class FSTP : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (DecodedInstruction.OpCode == 0xDDD8)
            {
                mProc.mFPU.Pop();
            }
            else
...
*/
    ...
    public class IN : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case TypeCode.Byte:
                    mProc.mem.SetByte(mProc, Op1Add, (byte)mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
                case TypeCode.UInt16:
                    mProc.mem.SetWord(mProc, Op1Add, (UInt16)mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
                case TypeCode.UInt32:
                    mProc.mem.SetDWord(mProc, Op1Add, mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
            }
        }
    }
    public class INVLPG : Instruct
    {
        ...
        public override void Impl()
        {
            DWord lMemAddr = mProc.mem.GetDWord(mProc, Op1Add);
            if (mProc.regs.CPL != 0)
            {
                //If not CPL = 0 then 
                mProc.ExceptionNumber = 0xD;
                if (mProc.mSystem.Debuggies.DebugMemPaging)
                    mProc.mSystem.PrintDebugMsg(eDebuggieNames.System, "Attempt to invalidate page containing address " + lMemAddr.ToString("X8") + " however CPL (" + mProc.regs.CPL.ToString("X1") + ") is not zero.  GPF (11) exception triggered");

            }
            else
            {
                mProc.mTLB.InvalidatePage(lMemAddr);
                mProc.mSystem.PrintDebugMsg(eDebuggieNames.System, "Invalidated page containing address " + lMemAddr.ToString("X8"));
            }
        }
    }
    ...
    public class INS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            DWord lLoopCounter = mProc.OpSize16 ? mProc.regs.CX : mProc.regs.ECX;
            ...
            do
            {
                if (DecodedInstruction.RealOpCode == 0x6c)
                {
                    ...
                    mProc.mem.SetByte(mProc, lDest, (byte)mProc.ports.In(mProc.regs.DX, TypeCode.Byte));
                    if (PageFaultException) return;
                ...
                else
                {
                    if (mProc.OpSize16)
                    {
                        if (mProc.AddrSize16)
                            ...
                            lDest = PhysicalMem.GetLocForSegOfs(mProc, mProc.regs.ES.Value, mProc.regs.EDI);
                        mProc.mem.SetWord(mProc, lDest, (Word)mProc.ports.In(mProc.regs.DX, TypeCode.UInt16));
                        if (PageFaultException) return;
                    ...
                    else
                    {
                        if (mProc.AddrSize16)
                            ...
                            lDest = PhysicalMem.GetLocForSegOfs(mProc, mProc.regs.ES.Value, mProc.regs.EDI);
                        mProc.mem.SetDWord(mProc, lDest, mProc.ports.In(mProc.regs.DX, TypeCode.UInt32));
                        if (PageFaultException) return;
                        ...
                        if ((lGDT.access.SegType != eGDTSegType.Code_Exec_Only_Conforming
                            ...
                            //(* code segment, DPL<CPL, VM=0 *)
                                ...
                                else    //INTERRUPT-FROM-VIRTUAL-8086-MODE;
                                {
                                    ...
                                    lPush.Op1Value.OpDWord = lTempSS; lPush.Impl();
                                    //X)X)X) Changed back XXX
                                    lPush.Op1Add = Processor_80x86.RESP;
                                    lPush.Op1Value.OpDWord = lTempESP; lPush.Impl();
                                    lPush.Op1Add = 0;
        ...
        public override void Impl()
        {
            ...
            {   //RETURN-FROM-VIRTUAL-8086-MODE
                ...
                else
                {
                    ...
                    //    a = a + 1 - 1;
//                    if (lTempEIP == 0x0)
                    //if (mProc.mem.GetDWord(mProc, mProc.regs.ESP) == 0x600137E2)
                    //    a += 1;
                    lPop.Impl();
                    ...
                    else    //PROTECTED-MODE-RETURN
                    {
                        if (mProc.mGDTCache[(int)lTempCS >> 3].access.PrivLvl > mProc.regs.CPL)
                        {
                            ...
                            lPop.Impl();
                            lTempESP = lPop.Op1Value.OpDWord;
                            lPop.Op1Add = Processor_80x86.RSS;
                            lPop.Impl();
                            lPop.Op1Add = 0;
                            lTempSS = lPop.Op1Value.OpWord;
                            mProc.regs.SS.Value = lTempSS;
                ...
                switch (Op1TypeCode)
                {
                    ...
                    case TypeCode.UInt32:
                        if (mProc.OperatingMode == ProcessorMode.Protected)
                        {
                            ...
                            {
                                mProc.regs.CS.Value = PhysicalMem.GetSegForLoc(mProc, Op1Value.OpQWord & 0x00FFFFFF);
                                mProc.regs.EIP = PhysicalMem.GetOfsForLoc(mProc, Op1Value.OpDWord);
                            }
                        }
                        else
                        {
                            if (lOpSize16 && lAddrSize16)
                            {
                                if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0xe8)
                                {
                                    if (!lIsNegative)
                                        mProc.regs.EIP += (UInt32)Op1Value.OpDWord;
                                    else
    ...
    public class JMPF : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (mProc.OperatingMode == ProcessorMode.Protected)
                mProc.mem.SetDWord(mProc, Processor_80x86.RCS, PhysicalMem.GetSegForLoc(mProc, (UInt32)Op2Value.OpWord));
            else
...
//#endif
    ...
    public class LGDT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (Op1Value.OpQWord != mProc.regs.GDTR.mOriginalValue)
            {
                ...
                if (mProc.OperatingMode != ProcessorMode.Real)
                    mProc.regs.GDTR.mBase = mProc.mem.PagedMemoryAddress(mProc, mProc.regs.GDTR.Base,false, ref PFException);
                if (PFException)
                    return;
    ...
    public class LIDT : Instruct
    {
        ...
        public override void Impl()
        {
            if (Op1Value.OpQWord != mProc.regs.IDTR.mOriginalValue)
            {
                ...
                if (mProc.OperatingMode != ProcessorMode.Real)
                    mProc.regs.IDTR.mBase = mProc.mem.PagedMemoryAddress(mProc, mProc.regs.IDTR.Base, false, ref PFException);
                if (PFException)
                    return;
            }
            mProc.RefreshIDTCache();
    ...
    public class LLDT : Instruct
    {
        ...
        public static void Load(Processor_80x86 mProc)
        {
            ...
            if (mProc.OperatingMode != ProcessorMode.Real && mProc.regs.LDTR.mSegSel != 0x0)
                mProc.regs.LDTR.mBase = mProc.mem.PagedMemoryAddress(mProc, mProc.regs.LDTR.Base, false, ref PFException);
            if (PFException)
                return;
    ...
    public class MOV : Instruct
    {
        ...
        public override void Impl()
        {
            if ((Op2Add >= Processor_80x86.REGADDRBASE + Processor_80x86.RCSOFS) && mProc.OperatingMode == ProcessorMode.Protected)
            {
                if (lOpSize16)
    ...
    public class MOVSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            MOVSW.SetupMOVSDest(mProc, ref lDest, lAddrSize16, false,false);
    ...
    public class MOVSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            MOVSW.SetupMOVSSrc(mProc, ref lSource, lAddrSize16, true);
            MOVSW.SetupMOVSDest(mProc, ref lDest, lAddrSize16, false,true);
    ...
    public class NEG : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            SetFlagsForSubtraction(mProc, lPreVal1, Op1Value, lOp1Val, Op1TypeCode, false);
            #region Instructions
            #endregion
        }
    }
    ...
    public class OUTS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                mProc.ports.Out(Op1Value.OpByte, mProc.mem.GetByte(mProc, lSource),TypeCode.Byte);
            ...
            else //if (mProc.mCurrentInstruction.ChosenOpCode.OpCode == 0x6f)
            {
                if (lAddrSize16)
                {
                    mProc.ports.Out(mProc.regs.DX, mProc.mem.GetWord(mProc, lSource), TypeCode.UInt16);
                }
                else
                {
                    mProc.ports.Out(mProc.regs.DX, mProc.mem.GetDWord(mProc, lSource), TypeCode.UInt32);
                }
                if (mProc.regs.FLAGSB.DF == false)
                    if (lAddrSize16)
                        mProc.regs.SI += 2;
    ...
    public class POP : Instruct
    {
        ...
        public override void Impl()
        {
            //06/26/2018 - Changed the following 2 lines to NOT use the stack sizes but rather the CS segment sizes
    ...
    public class PUSH : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if ((Op1Add >= Processor_80x86.REGADDRBASE + Processor_80x86.RCSOFS) && mProc.OperatingMode == ProcessorMode.Protected)
            {
            ...
            if (lAddrSize16)
            {
                //Added sign extension logic 
                if (Op1TypeCode == TypeCode.Byte)
                {
                    Op1TypeCode = TypeCode.UInt16;
                    //CLR - 06/27/2013 -  The newer IA-64/IA-32 manual says this but the old IA-32 manual DOES NOT
                    ...
                    //if (!Operand2IsRef)
                    //    lTemp16 = (Word)(0xFF00 | lTemp16);
                }
                //CLR - 06/27/2013 -  The newer IA-64/IA-32 manual says this but the old IA-32 manual DOES NOT
                //                  If the source operand is an immediate and its size is less than the operand size, a sign-extended value is pushed on the stack
                //if (!Operand2IsRef && !lOpSize16 && (Op1TypeCode == TypeCode.UInt16))
                //{
                //    lTemp32 = (DWord)(0xFFFF0000 | lTemp16);
                //    Op1TypeCode = TypeCode.UInt32;
                //}
    ...
    public class RDTSC : Instruct
    {
        ...
        public override void Impl()
        {
            mProc.regs.EAX = (UInt32)mProc.mTSC;
            mProc.regs.EDX = (UInt32)(((mProc.mTSC) & 0xFFFFFFFF00000000) >> 32);
            #region Instructions
            #endregion
        }
    }
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.mem.SetByte(mProc, Op1Add, lOp1ValSigned.OpByte);
                    mProc.regs.setFlagCF_SBB(lPreVal1.OpByte, lOp1ValSigned.OpByte, Op2Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1ValSigned.OpWord = (Word)(lOp1ValSigned.OpWord - (lOp2Value.OpWord + (mProc.regs.FLAGS & 0x01)));
                    mProc.mem.SetWord(mProc, Op1Add, lOp1ValSigned.OpWord);
                    mProc.regs.setFlagCF_SBB(lPreVal1.OpWord, lOp1ValSigned.OpWord, Op2Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    lOp1ValSigned.OpDWord = (DWord)(lOp1ValSigned.OpDWord - (lOp2Value.OpDWord + (mProc.regs.FLAGS & 0x01)));
                    mProc.mem.SetDWord(mProc, Op1Add, lOp1ValSigned.OpDWord);
                    mProc.regs.setFlagCF_SBB(lPreVal1.OpDWord, lOp1ValSigned.OpDWord, Op2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1ValSigned.OpQWord = (QWord)(lOp1ValSigned.OpQWord - (lOp2Value.OpQWord + (byte)(mProc.regs.FLAGS & 0x01)));
                    mProc.mem.SetQWord(mProc, Op1Add, lOp1ValSigned.OpQWord);
                    mProc.regs.setFlagCF_SBB(lPreVal1.OpQWord, lOp1ValSigned.OpQWord, Op2Value.OpQWord);
                    break;
            }
    ...
    public class SCASB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //notice that we don't save the result, we just use it to save the flags
            SetFlagsForSubtraction(mProc, lPreVal1, lTemp, lAL, TypeCode.Byte, true);
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpByte, lTemp.OpByte, lAL.OpByte);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpByte, lTemp.OpByte, lAL.OpByte);
            MOVSW.IncDec(mProc, ref lJunk1, ref lJunk2, lAddrSize16, 1, false, true, false, false);
    ...
    public class SCASD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //notice that we don't save the result, we just use it to save the flags
            //06/27/2013 - FIX ME!!! mProc.regs.setFlagCF(lPreVal1.OpDWord, lAL.OpDWord, lTemp.OpDWord);
            SetFlagsForSubtraction(mProc, lPreVal1, lTemp, lAL, TypeCode.UInt32, true);
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpDWord, lTemp.OpDWord, lAL.OpDWord);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpDWord, lTemp.OpDWord, lAL.OpDWord);
            MOVSW.IncDec(mProc, ref lJunk1, ref lJunk2, lAddrSize16, 4, false, true, false, false);
    ...
    public class SCASW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //06/27/2013 - FIX ME!!! mProc.regs.setFlagCF(lPreVal1.OpWord, lAL.OpWord, lTemp.OpQWord);
            SetFlagsForSubtraction(mProc, lPreVal1, lTemp, lAL, TypeCode.UInt16, true);
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpWord, lTemp.OpWord, lAL.OpWord);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpWord, lTemp.OpWord, lAL.OpWord);
            MOVSW.IncDec(mProc, ref lJunk1, ref lJunk2, lAddrSize16, 2, false, true, false, false);
...
Instruct lMov = mProc.Instructions["MOV"];
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    {
                        mProc.regs.setFlagCF(lOp1Value.OpByte >> lTopBitNum == 1);
                        lOp1Value.OpByte *= 2;
                    }
                    mProc.mem.SetByte(mProc, Op1Add, lOp1Value.OpByte);
                    mProc.regs.setFlagSF(lOp1Value.OpByte);
            if ( (lTempCount & 0x1F) == 1)
                mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpByte, lTopBitNum)) == 1) ^ mProc.regs.FLAGSB.CF);
                    break;
                case TypeCode.UInt16:
                    lTopBitNum = 15;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    {
                        mProc.regs.setFlagCF(lOp1Value.OpWord >> lTopBitNum == 1);
                        lOp1Value.OpWord *= 2;
                    }
                    mProc.mem.SetWord(mProc, Op1Add, lOp1Value.OpWord);
                    mProc.regs.setFlagSF(lOp1Value.OpWord);
            if ( (lTempCount & 0x1F) == 1)
                mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpWord, lTopBitNum)) == 1) ^ mProc.regs.FLAGSB.CF);
                    break;
                case TypeCode.UInt32:
                    lTopBitNum = 31;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    {
                        if (cnt == lTempCount - 1)
                            mProc.regs.setFlagCF(lOp1Value.OpDWord >> lTopBitNum == 1);
                        lOp1Value.OpDWord *= 2;
                    }
                    mProc.mem.SetDWord(mProc, Op1Add, lOp1Value.OpDWord);
                    mProc.regs.setFlagSF(lOp1Value.OpDWord);
            if ( (lTempCount & 0x1F) == 1)
                mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpDWord, lTopBitNum)) == 1) ^ mProc.regs.FLAGSB.CF);
                    break;
                case TypeCode.UInt64:
                    lTopBitNum = 63;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    {
                        mProc.regs.setFlagCF(lOp1Value.OpQWord >> lTopBitNum == 1);
                        lOp1Value.OpQWord *= 2;
                    }
                    mProc.mem.SetQWord(mProc, Op1Add, lOp1Value.OpQWord);
                    mProc.regs.setFlagSF(lOp1Value.OpQWord);
            if ( (lTempCount & 0x1F) == 1)
                mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpQWord, lTopBitNum)) == 1) ^ mProc.regs.FLAGSB.CF);
                    break;
            }
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpByte);
                    if ((lTempCount & 0x1F) == 1)
                        mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpByte, lTopBitNum)) == 1));
                    break;
                case TypeCode.UInt16:
                    lTopBitNum = 15;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpWord);
                    if ((lTempCount & 0x1F) == 1)
                        mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpWord, lTopBitNum)) == 1));
                    break;
                case TypeCode.UInt32:
                    lTopBitNum = 31;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpDWord);
                    if ((lTempCount & 0x1F) == 1)
                        mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpDWord, lTopBitNum)) == 1));
                    break;
                case TypeCode.UInt64:
                    lTopBitNum = 63;
                    for (UInt16 cnt = 0; (cnt) < lTempCount; cnt++)
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpQWord);
                    if ((lTempCount & 0x1F) == 1)
                        mProc.regs.setFlagOF(((Misc.getBit(lOp1Value.OpQWord, lTopBitNum)) == 1));
                    break;
            }
    ...
    public class WRMSR : Instruct
    {
        public WRMSR()
        {
            ...
            mProcPentium = true;
            mProcPentiumPro = true;
            mDescription = "Write the value in EDX:EAX to MSR specified by ECX";
            mModFlags = 0;
        }
        public override void Impl()
        {
            switch (mProc.regs.ECX)
            {
                case 0x10:
                    mProc.mTSC = (QWord)((mProc.regs.EDX << 32) | mProc.regs.EAX);
                    mProc.mSystem.PrintDebugMsg(eDebuggieNames.System, "Write to MSR = " + mProc.regs.ECX.ToString("X8") + " with EDX:EAX= " + mProc.regs.EDX.ToString("X8") + ":" + mProc.regs.EAX.ToString("X8"));
                    break;
                default:
                    mProc.mSystem.PrintDebugMsg(eDebuggieNames.System, "WRMSR - register not yet coded.  Write to MSR=" + mProc.regs.ECX.ToString("X8") + " with EDX:EAX= " + mProc.regs.EDX.ToString("X8") + ":" + mProc.regs.EAX.ToString("X8"));
                    break;
            }
        }
    }
