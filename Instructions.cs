...
namespace VirtualProcessor
{
    ...
    public class ADC : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!Operand2IsRef && (Op2TypeCode != Op1TypeCode))
                Misc.SignExtend(ref lOp2Value, ref Op2TypeCode, Op1TypeCode);
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpByte);
                    mProc.regs.setFlagCF_ADC(Op1Value.OpByte, lOp1ValSigned.OpByte, lOp2Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    ...
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpWord);
                    mProc.regs.setFlagCF_ADC(Op1Value.OpWord, lOp1ValSigned.OpWord, lOp2Value.OpWord);
                    break;
                case TypeCode.UInt32:
                   ...
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpDWord);
                   mProc.regs.setFlagCF_ADC(Op1Value.OpDWord, lOp1ValSigned.OpDWord, lOp2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    ...
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpQWord);
                    mProc.regs.setFlagCF_ADC(Op1Value.OpQWord, lOp1ValSigned.OpQWord, lOp2Value.OpQWord);
                    break;
            }
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.regs.setFlagCF_Add(Op1Value.OpByte, lOp1ValSigned.OpByte, lOp2Value.OpByte);
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1ValUnsigned.OpWord += Op2Value.OpWord;
                    lOp1ValSigned.OpWord = (UInt16)((Int16)lOp1ValSigned.OpWord + (Int16)lOp2Value.OpWord);
                    mProc.regs.setFlagCF_Add(Op1Value.OpWord, lOp1ValSigned.OpWord, lOp2Value.OpWord);
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpWord);
                    break;
                case TypeCode.UInt32:
                   ...
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpDWord);
                   mProc.regs.setFlagCF_Add(Op1Value.OpDWord, lOp1ValSigned.OpDWord, lOp2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1ValUnsigned.OpQWord += Op2Value.OpQWord;
                    lOp1ValSigned.OpQWord = (UInt64)((Int64)lOp1ValSigned.OpQWord + (Int64)lOp2Value.OpQWord);
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, lOp1ValSigned.OpQWord);
                    mProc.regs.setFlagCF_Add(Op1Value.OpQWord, lOp1ValSigned.OpQWord, lOp2Value.OpQWord);
                    break;
            }
    ...
    public class ARPL : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if ( (Op1Value.OpWord & 0x3) < (Op2Value.OpWord & 0x3) )
            {
                mProc.regs.setFlagZF(true);
                mProc.mem.SetWord(mProc, ref mProc.mCurrentInstruction.DecodedInstruction, Op1Add, (Word)( (Op1Value.OpWord & 0xFC) + (Op2Value.OpWord & 0x3)));
            }
            else
    ...
    public class BSF : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if ((lTopBitNum == 15 && Op2Value.OpWord == 0) || (lTopBitNum == 31 && Op2Value.OpDWord == 0))
            {
                ...
                Op1Value.OpQWord = 0;
                if (lTopBitNum == 15)
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Op1Value.OpWord);
                else
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op1Value.OpDWord);
            }
            else
            {
                mProc.regs.setFlagZF(false);
                for (int c = 0; c <= lTopBitNum; c++)
                    if (Misc.GetBits3(Op2Value.OpQWord, c, 1) == 1)
                    {
                        ...
                        {
                            Op1Value.OpDWord = (DWord)c;
                           mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op1Value.OpDWord);
                        }
                        return;
                    }
                if (lTopBitNum == 15)
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, 0);
                else
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, 0);
            }
            ///AF flag undefined
            #region Instructions
            #endregion
    ...
    public class BSWAP : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            lDest += (UInt32)((Op1Value.OpDWord & 0x00FF0000) >> 8);
            lDest += (UInt32)((Op1Value.OpDWord & 0xFF000000) >> 24);

           mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lDest);
    ...
    public class BT : Instruct
    {
        ...
        public override void Impl()
        {
            if (Op1Add >= Processor_80x86.REGADDRBASE && (Op1Add <= Processor_80x86.REGADDRBASE + Processor_80x86.RSSOFS))
                mProc.regs.setFlagCF(Misc.GetBits3(Op1Value.OpQWord, (int)Op2Value.OpByte, 1) == 1);
            else
            {
                mProc.regs.setFlagCF(TestBit(mProc.mem.GetByte(mProc, ref DecodedInstruction, Op1Add + (Op2Value.OpDWord / 8)), (int)(Op2Value.OpDWord % 8)));
            }
            ///AF flag undefined
            #region Instructions
            #endregion
    ...
    public class BTC : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (Op1Add >= Processor_80x86.REGADDRBASE && (Op1Add <= Processor_80x86.REGADDRBASE + Processor_80x86.RSSOFS))
            {
               ...
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lOp1Val.OpDWord);
            }
            else
            {
                lTheByte = mProc.mem.GetByte(mProc, ref DecodedInstruction, Op1Add + (Op2Value.OpDWord / 8));
                if (BT.TestBit(lTheByte, (int)(Op2Value.OpDWord % 8)))
                {
                    mProc.regs.setFlagCF(true);
                    lTheByte = Misc.setBit(lTheByte, (int)(Op2Value.OpDWord % 8), false);
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add + (Op2Value.OpDWord / 8), lTheByte);
                }
                else
                {
                    mProc.regs.setFlagCF(false);
    ...
    public class BOUND : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            int lUpperBound = (int)mProc.mem.GetWord(mProc, ref DecodedInstruction, GetSegOverriddenAddress(mProc, Op2Add + 2));
            int lCheckVal = (int)Op1Value.OpDWord;
            if (lCheckVal < lLowerBound || lCheckVal > lUpperBound)
            {
                Instruct lINT = mProc.Instructions["INT"];
                lINT.Op1Value.OpQWord = 5;
                lINT.DecodedInstruction = DecodedInstruction;
                lINT.Impl();
                DecodedInstruction = lINT.DecodedInstruction;
            }
            //NOTES:
    ...
    public class CALL : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            lPush.DecodedInstruction = DecodedInstruction;
            Instruct lJMP = mProc.Instructions["JMP"];
            lJMP.DecodedInstruction = DecodedInstruction;
            ...
            switch (ChosenOpCode.OpCode)
            {
                ...
                if (lPush.DecodedInstruction.ExceptionThrown)
                {
                    ...
                    lJMP.Impl();
                if (lJMP.DecodedInstruction.ExceptionThrown)
                {
                    DecodedInstruction = lJMP.DecodedInstruction;
                    return;
                }
break;
                case 0xff03:
                    break;
                default:
                    lPush.Op1Add = Processor_80x86.RCS;
                    if (Processor_80x86.mProtectedModeActive)
                        lPush.Op1Value.OpDWord = mProc.regs.CS.mWholeSelectorValue;
                    else
                ...
                if (mProc.OperatingMode == ProcessorMode.Protected && mProc.regs.CS.mDescriptorNum > 0 && mProc.regs.CS.mDescriptorNum <= mProc.mGDTCache.Count)
                    {
                       mProc.mem.SetDWord(mProc, ref DecodedInstruction, Processor_80x86.RCS, PhysicalMem.GetSegForLoc(mProc, Op1Value.OpDWord));
            ...
            return;
            if (Op1TypeCode == TypeCode.UInt32 && lOpSize16)
            {
                lPush.Op1Add = Processor_80x86.RCS;
                lPush.Op1Value.OpDWord = mProc.regs.CS.Value;
                lPush.Impl();
    ...
    public class CALLF : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            lPush.Op1Add = Processor_80x86.RIP;
            lPush.Op1Value.OpDWord = mProc.regs.EIP;
            lPush.Impl();
            lPush.Op1Add = 0x0;
            ...
            if (Processor_80x86.mProtectedModeActive)
            {
                ...
                {
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Processor_80x86.RCS, PhysicalMem.GetSegForLoc(mProc, Op1Value.OpDWord));
                    mProc.regs.EIP = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op1Add);
                }
                else
                {
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Processor_80x86.RCS, (DWord)(Op1Value.OpQWord >> 32) & 0xFFFF);
                    mProc.regs.EIP = mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op1Add);
                }
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Processor_80x86.RCS, Op1Value.OpDWord >> 0x10);
                mProc.regs.EIP = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op1Add);
            }
            #region Instructions
            #endregion
    ...
    */
    ...
    public class CMOVcc : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (lExecuteMove)
            {
                ...
                lMov.DecodedInstruction = DecodedInstruction;
                ...
                lMov.Impl();
                DecodedInstruction = lMov.DecodedInstruction;
            }
        }
    }
    public class CMP : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    lOp1ValSigned.OpByte -= lOp2Value.OpByte;
                    mProc.regs.setFlagCF_SUB_CMP(Op1Value.OpByte, lOp1ValSigned.OpByte, lOp2Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1ValSigned.OpWord -= lOp2Value.OpWord;
                    mProc.regs.setFlagCF_SUB_CMP(Op1Value.OpWord, lOp1ValSigned.OpWord, lOp2Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    lOp1ValSigned.OpDWord -= lOp2Value.OpDWord;
                    mProc.regs.setFlagCF_SUB_CMP(Op1Value.OpDWord, lOp1ValSigned.OpDWord, lOp2Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1ValSigned.OpQWord -= lOp2Value.OpQWord;
                    mProc.regs.setFlagCF_SUB_CMP(Op1Value.OpQWord, lOp1ValSigned.OpQWord, lOp2Value.OpQWord);
                    break;
            }
            SetFlagsForSubtraction(mProc, Op1Value, lOp2Value, lOp1ValSigned, Op1TypeCode);
        }
    }
    public class CMPSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            DWord lLoopCounter = mProc.AddrSize16 ? mProc.regs.CX : mProc.regs.ECX;
            ...
            do
            {
                Value1.OpByte = mProc.mem.GetByte(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown) return;
                Value2.OpByte = mProc.mem.GetByte(mProc, ref DecodedInstruction, lDest);
                if (DecodedInstruction.ExceptionThrown) return;
                ...
                MOVSW.IncDec(mProc, ref lDest, ref lSource, mProc.AddrSize16, 1, true, true, true, false);
    ...
    public class CMPSW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!lOpSize16)
            {
                Instruct lCMPSD = mProc.Instructions["CMPSD"];
                lCMPSD.DecodedInstruction = DecodedInstruction;
                lCMPSD.Impl();
                DecodedInstruction = lCMPSD.DecodedInstruction;
                return;
            }
            ...
            do
            {
                Value1.OpWord = mProc.mem.GetWord(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown) return;
                Value2.OpWord = mProc.mem.GetWord(mProc, ref DecodedInstruction, lDest);
                if (DecodedInstruction.ExceptionThrown) return;
                sOpVal lPreVal1 = Value1;
                ...
                MOVSW.IncDec(mProc, ref lDest, ref lSource, mProc.AddrSize16, 2, true, true, true, false);
                if (mProc.mRepeatCondition == Processor_80x86.REPEAT_TILL_NOT_ZERO && mProc.regs.FLAGSB.ZF == true)
                {
                    mProc.mRepeatCondition = Processor_80x86.NOT_REPEAT;
                    break;
    ...
    public class CMPSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            do
            {
                Value1.OpDWord = mProc.mem.GetDWord(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown) return;
                Value2.OpDWord = mProc.mem.GetDWord(mProc, ref DecodedInstruction, lDest);
                if (DecodedInstruction.ExceptionThrown) return;
                sOpVal lPreVal1 = Value1;
                ...
                MOVSW.IncDec(mProc, ref lDest, ref lSource, mProc.AddrSize16, 4, true, true, true, false);
                if (mProc.mRepeatCondition == Processor_80x86.REPEAT_TILL_NOT_ZERO && mProc.regs.FLAGSB.ZF == true)
                {
                    mProc.mRepeatCondition = Processor_80x86.NOT_REPEAT;
                    break;
    ...
    public class CMPXCHG : Instruct
    {
        ...
        public override void Impl()
        {
            switch (this.ChosenOpCode.OpCode)
            {
                case 0x0FB0:    //8-bit
                    if (mProc.regs.AL == Op1Value.OpByte)
                    {
                        mProc.regs.setFlagZF(true);
                        mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpByte);
                    }
                    else
                    {
                        mProc.regs.setFlagZF(false);
                        mProc.regs.AL = Op1Value.OpByte;
                    }
                    break;
                case 0x0FB1:
                    if (mProc.OpSize16)    //16-bit
                        if (mProc.regs.AX == Op1Value.OpWord)
                        {
                            mProc.regs.setFlagZF(true);
                            mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpWord);
                        }
                        else
                        {
                            mProc.regs.setFlagZF(false);
                            mProc.regs.AX = Op1Value.OpWord;
                        }
                    else     //32-bit
                        if (mProc.regs.EAX == Op1Value.OpDWord)
                        {
                            mProc.regs.setFlagZF(true);
                            mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpDWord);
                        }
                        else
                        {
                            mProc.regs.setFlagZF(false);
                            mProc.regs.EAX = Op1Value.OpDWord;
                        }
                    break;
                default:
        ...
        public override void Impl()
        {
            switch (mProc.regs.EAX)
            {
                ...
                case 0x01:
                    ...
                    mProc.regs.EDX = 0x2011; //(FPU, PGE, TSC=2011)
                    break;
                case 0x80000000:
                    mProc.regs.EAX = 0x1;
                    mProc.regs.EBX = 0x68747541;
    ...
    */
    ...
    public class DEC : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    lOp1Value.OpByte--;
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpByte);
                    Op2Value.OpByte = 0xff;
                    mProc.regs.setFlagSF(lOp1Value.OpByte);
                    mProc.regs.setFlagOF_Sub(lOp1Value.OpByte, Op2Value.OpByte, Op1Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1Value.OpWord--;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpWord);
                    Op2Value.OpWord = 0xffff;
                    mProc.regs.setFlagSF(lOp1Value.OpWord);
                    mProc.regs.setFlagOF_Sub(lOp1Value.OpWord, Op2Value.OpWord, Op1Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    lOp1Value.OpDWord--;
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpDWord);
                    Op2Value.OpDWord = 0xffffffff;
                    mProc.regs.setFlagSF(lOp1Value.OpDWord);
                    mProc.regs.setFlagOF_Sub(lOp1Value.OpDWord, Op2Value.OpDWord, Op1Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1Value.OpQWord--;
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpQWord);
                    Op2Value.OpQWord = 0xffffffffffffffff;
                    mProc.regs.setFlagSF(lOp1Value.OpQWord);
                    mProc.regs.setFlagOF_Sub(lOp1Value.OpQWord, Op2Value.OpQWord, Op1Value.OpQWord);
                    break;
            }
    ...
    public class DIV : Instruct
    {
        ...
        public override void Impl()
        {
            if (Op1Value.OpQWord == 0)
            {
                ...
                DecodedInstruction.ExceptionNumber = 0x0;
    ...
    public class ENTER : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (mProc.AddrSize16)
            {
                lPush.Op1Add = Processor_80x86.RBP;
            ...
            {
                lPush.Op1Add = Processor_80x86.REBP;
            ...
            if (lOp2Value.OpByte > 0)
            {
                ...
                {
                    if (!lOpSize16) //32 bit operand size
                    {
    ...
    public class FABS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.mFPU.mDataReg[mProc.mFPU.ST(0)].mHigh16 &= 0x7fff;
            #region Instructions
            /*
    */
            #endregion
    ...
    public class FADD : Instruct
    {
        ...
        public override void Impl()
        {
            switch (DecodedInstruction.OpCode)
            {
                ...
                case 0xD800:
                    mProc.mFPU.Add(0, System.Convert.ToDouble(Op1Value.OpDWord), 1, false, false);
                    break;
                //DA /0 FIADD m32int Add m32int to ST(0) and store result in ST(0)
                case 0xDA00:
                    mProc.mFPU.Add(0, System.Convert.ToDouble(Op1Value.OpDWord), FPU.FPU_DEST_INTERNAL_SOURCE_EXTERNAL, true, false);
                    break;
                default:
    ...
    */
    ...
    public class FCHS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            lTemp = ~(lTemp);
            mProc.mFPU.DataReg[mProc.mFPU.ST(0)] = new EPDouble(System.Convert.ToDouble(lTemp));
        }
    }
    public class FCMOV : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (DecodedInstruction.OpCode >= 0xDAC0 && DecodedInstruction.OpCode <= 0xDAC7)
            {
                if (mProc.regs.FLAGSB.CF)
                    mProc.mFPU.DataReg[mProc.mFPU.ST(0)] = mProc.mFPU.DataReg[mProc.mFPU.ST( (int)(DecodedInstruction.OpCode - 0xDAC0))];
                return;
            }
    ...
    public class FCOM : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            switch (DecodedInstruction.OpCode)
            {
                ...
                case 0xD8D7:
                    ...
                    lReg1 = mProc.mFPU.GetDataRegDouble(mProc.mFPU.ST((int)(mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xD8D0)));
                    Compare(lReg0, lReg1);
                    break;
                case 0xD8D8:
                case 0xD8D9:
                ...
                case 0xD8DF:
                    ...
                    lReg1 = mProc.mFPU.GetDataRegDouble( mProc.mFPU.ST((int)(mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xD8D8)));
                    Compare(lReg0, lReg1);
                    mProc.mFPU.Pop();
                    break;
                default:
        ...
        public void Compare(double Reg0, double Reg1)
        {
            if (Double.IsNaN(Reg0) || Double.IsNaN(Reg1))
            {
    ...
    */
    ...
    public class FDIV : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case 0xDC06:
                    mProc.mFPU.Divide(0, System.Convert.ToDouble(Op1Value.OpQWord), FPU.FPU_DEST_INTERNAL_SOURCE_EXTERNAL, false, false);
                    break;
                case 0xDEF9: 
                ...
                case 0xD8F7:
                    ...
                    mProc.mFPU.Divide(0, mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xD8F0, 2, false, false);
                    break;
                default:
                    throw new Exception("Not coded yet");
            }
        ...
        public override void Impl()
        {
            switch (DecodedInstruction.OpCode)
            {
                case 0xDA07:
                    ...
                    mProc.mFPU.Divide(mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op1Add), 0, 1, true, false);
                    break;
                ...
                case 0xDE07:
                    ...
                    mProc.mFPU.Divide(Op1Value.OpWord, 0, 1, true, false);
                    break;
                case 0xDEF0:
                case 0xDEF1:
                case 0xDEF2:
                ...
                case 0xDEF7:
                    ...
                    mProc.mFPU.Divide(mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xDEF0, 0, 2, false, true);
                    break;
                default:
                    throw new Exception("Not coded yet");
            }
    ...
    */
    ...
    public class FINIT : Instruct
    {
        ...
        public override void Impl()
        {
            Instruct lFWAIT = mProc.Instructions["FWAIT"];
            lFWAIT.DecodedInstruction = DecodedInstruction;
            lFWAIT.Impl();
            DecodedInstruction = lFWAIT.DecodedInstruction;
            mProc.mFPU.Init();
            #region Instructions
            /*
    */
            ...
            switch (DecodedInstruction.OpCode)
            {
                case 0xDF02:
                    //DF /2 FIST m16int Store ST(0) in m16int
                        mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (Word)System.Convert.ToInt16(mProc.mFPU.GetDataRegSingle(mProc.mFPU.ST(0))));
                    break;
                case 0xDB02:
                    //DB /2 FIST m32int Store ST(0) in m32int
                        mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (DWord)System.Convert.ToInt32(mProc.mFPU.GetDataRegDouble(mProc.mFPU.ST(0))));
                ...
                case 0xDF03:
                    try
                    {
                        ...
                        mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (Word)System.Convert.ToInt16(mProc.mFPU.Pop()));
                    }
                    catch
                    {
                        mProc.mFPU.mStatusReg.InvalidOp = true;
                ...
                case 0xDB03:
                    try
                    {
                       mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (DWord)System.Convert.ToInt32(mProc.mFPU.Pop()));
                    }
                    catch
                    {
                        mProc.mFPU.mStatusReg.InvalidOp = true;
                ...
                case 0xDF07:
                    try
                    {
                        mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, (QWord)System.Convert.ToInt64(mProc.mFPU.Pop()));
                    }
                    catch
                    {
                        mProc.mFPU.mStatusReg.InvalidOp = true;
        ...
        public override void Impl()
        {
            ...
            switch (DecodedInstruction.OpCode)
            {
                case 0xD900:
                    ...
                    mProc.mFPU.PushEPDouble(new EPDouble(System.Convert.ToDouble(Op1Value.OpDWord)));
                    break;

                case 0xDD00:
                    //DD /0 FLD m64fp Valid Valid Push m64fp onto the FPU register stack.
                    mProc.mFPU.PushEPDouble(new EPDouble(System.Convert.ToDouble(Op1Value.OpQWord)));
                    break;
                case 0xDB05:
                    //DB /5 FLD m80fp Valid Valid Push m80fp onto the FPU register stack.
                    bytes = mProc.mem.Chunk(mProc, ref DecodedInstruction, 0, Op1Add, 8);
                    mProc.mFPU.PushEPDouble(new EPDouble(BitConverter.ToDouble(bytes, 0)));
                    break;
                case 0xD9C0:
                case 0xD9C1:
                case 0xD9C2:
                ...
                case 0xD9C7:
                    ...
                    mProc.mFPU.PushEPDouble(mProc.mFPU.mDataReg[mProc.mFPU.ST((int)DecodedInstruction.OpCode & 0x7)]);
                    break;
                default:
                    throw new Exception("Not coded yet");
            }
    ...
    */
    ...
    public class FLD1 : Instruct
    {
        ...
        public override void Impl()
        {
            mProc.mFPU.PushEPDouble(new EPDouble(1));
            #region Instructions
            /*
    */
            #endregion
    ...
    public class FLDZ : Instruct
    {
        ...
        public override void Impl()
        {
            mProc.mFPU.PushEPDouble(new EPDouble(0));
            #region Instructions
            /*
    */
            #endregion
    ...
    public class FMUL : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case 0xD801:
                    mProc.mFPU.Multiply(0, System.Convert.ToDouble(Op1Value.OpDWord), FPU.FPU_DEST_INTERNAL_SOURCE_EXTERNAL, false, false);
                    break;
                case 0xDC01:
                ...
                case 0xDECE:
                case 0xDECF:
                    mProc.mFPU.Multiply( (mProc.mFPU.ST((int)DecodedInstruction.OpCode & 0xF)-8), 0, 2, false, true);
                    break;
                case 0xDCC8:
                case 0xDCC9:
                case 0xDCCa:
                ...
                case 0xDCCe:
                case 0xDCCf:
                    mProc.mFPU.Multiply(0, mProc.mFPU.ST((int)DecodedInstruction.OpCode - 0xDCC8), 2, false, false);
                    break;
                default:
                    throw new Exception("Not coded yet");
            }
    ...
    */
    ...
    public class FSAVE : Instruct
    {
        ...
        public override void Impl()
        {
            UInt32 lOp1Add = Op1Add + 24;
            Instruct lFSTENV = mProc.Instructions["FSTENV"];
            lFSTENV.DecodedInstruction = DecodedInstruction;
            lFSTENV.Impl();
            if (lFSTENV.DecodedInstruction.ExceptionThrown)
            {
                DecodedInstruction = lFSTENV.DecodedInstruction;
                return;
            }

            //HACK: need to code based on OpSize16
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[0]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[1]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[2]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[3]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[4]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[5]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[6]));
            lOp1Add += 8;
            mProc.mem.SetQWord(mProc, ref DecodedInstruction, lOp1Add, System.Convert.ToUInt64(mProc.mFPU.DataReg[7]));
    ...
    public class FST : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case 0xD902:
                    mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, System.Convert.ToUInt32(mProc.mFPU.GetDataRegDouble(mProc.mFPU.ST(0))));
                    break;
                ...
                case 0xDD03:
                    ...
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, (UInt64)BitConverter.DoubleToInt64Bits(mProc.mFPU.GetDataRegDouble(0)));
                    if (DecodedInstruction.OpCode == 0xDD03)
                        mProc.mFPU.Pop();
                    break;
                default:
                    throw new Exception("Not coded yet");
    ...
    */
    ...
    public class FSTCW : Instruct
    {
        ...
        public override void Impl()
        {
            mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mFPU.mControlReg.Value);
            #region Instructions
            /*
    */
            #endregion
    ...
    public class FSTENV : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (Processor_80x86.mProtectedModeActive)
                ...
                if (mProc.OpSize16)
                {   //16 bit Protected
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mControlReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mStatusReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mTagReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastIP));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastSegSel));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandPtr));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandSegSel));
                }
                else
                {   //32 bit Protected
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mControlReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, 0);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mStatusReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, 0);
                    ...
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, 0);
                    lOp1Add += 2;
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastIP));
                    lOp1Add += 4;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastSegSel));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOpCode & 0x7FF));
                    lOp1Add += 2;
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandPtr));
                    lOp1Add += 4;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandSegSel));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mTagReg.Value);
                ...
                {   //16 bit Real/VMode
                    ...
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mTagReg.Value);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastIP & 0xFFFF));
                    lOp1Add += 2;
                    Word lTemp = (Word)(mProc.mFPU.mLastIP & 0xF0000 >> 4);
                    lTemp |= (Word)(mProc.mFPU.mLastOpCode & 0x7FF);
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, lTemp);
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandPtr & 0xFFFF));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandPtr & 0xF0000 >> 4));
                }
                else
                {   //32 bit Real/VMode
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, mProc.mFPU.mControlReg.Value);
                    ...
                    lTemp |= (Word)(mProc.mFPU.mLastOpCode & 0x7FF);
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, lOp1Add, lTemp);
                    lOp1Add += 4;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, (Word)(mProc.mFPU.mLastOperandPtr & 0xFFFF));
                    lOp1Add += 2;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, lOp1Add, 0);
                    lOp1Add += 2;
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, lOp1Add, (DWord)(mProc.mFPU.mLastIP & 0xFFFF0000 >> 4));
                }
    ...
    */
    ...
    public class FSTP : Instruct
    {
        public FSTP()
        {
            ...
            mProcPentium = true;
            mProcPentiumPro = true;
            mDescription = "FPU: Store top of stack";
            mModFlags = 0;
            FPUInstruction = true;
        }
        public override void Impl()
        {
            ...
            switch (DecodedInstruction.OpCode)
            {
                case 0xD903:
                    //D9 /3 FSTP m32fp Valid Valid Copy ST(0) to m32fp and pop register stack.
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, System.Convert.ToUInt32(mProc.mFPU.GetDataRegSingle(mProc.mFPU.ST(0))));
                    break;
                case 0xDDD8:
                case 0xDDD9:
                case 0xDDDA:
                ...
                case 0xDDDF:
                    ...
                    mProc.mFPU.mDataReg[mProc.mFPU.ST((int)DecodedInstruction.OpCode - 0xDDD8)] = mProc.mFPU.mDataReg[mProc.mFPU.ST(0)];
                    mProc.mFPU.Pop();
                    break;
                default:
                    throw new Exception("ruh roh butt wheat");
    ...
    */
    ...
    public class FSUB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case 0xDA04:
                    mProc.mFPU.Sub(0, System.Convert.ToDouble(Op1Value.OpDWord), FPU.FPU_DEST_INTERNAL_SOURCE_EXTERNAL, true, false);
                    break;
                case 0xD8E0:
                case 0xD8E1:
                case 0xD8E2:
                ...
                case 0xD8E6:
                case 0xD8E7:
                    mProc.mFPU.Sub(0, DecodedInstruction.OpCode - 0xD8E0, 2, false, false);
                    break;
                default:
                    throw new Exception("Not coded yet");
            }
    ...
    */
    ...
    public class FXCH : Instruct
    {
        ...
        {
            EPDouble lTemp;
            switch (mProc.mCurrentInstruction.DecodedInstruction.OpCode)
            {
                case 0xD9C8:
                case 0xD9C9:
                case 0xD9Ca:
                ...
                case 0xD9Cf:
                    ...
                    mProc.mFPU.DataReg[mProc.mFPU.ST(0)] = mProc.mFPU.DataReg[mProc.mFPU.ST((int)mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xD9C8)];
                    mProc.mFPU.DataReg[mProc.mFPU.ST((int)mProc.mCurrentInstruction.DecodedInstruction.OpCode - 0xD9C8)] = lTemp;
                    break;
    ...
    public class HLT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!VerifyCPL0(mProc, ref DecodedInstruction))
                return;
...
*/
    ...
    public class IDIV : Instruct
    {
        ...
        public override void Impl()
        {
            if (Op1Value.OpQWord == 0)
            {
                DecodedInstruction.ExceptionNumber = 0x00;
                DecodedInstruction.ExceptionThrown = true;
                DecodedInstruction.ExceptionAddress = DecodedInstruction.InstructionAddress;
                DecodedInstruction.ExceptionErrorCode = 0;
                return;
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.regs.AL = (byte)(lTempAX / (Int16)Op1Value.OpByte);
                    mProc.regs.AH = (byte)(lTempAX % (UInt16)Op1Value.OpByte);
                    break;
                case TypeCode.UInt16:
                ...
                case TypeCode.UInt32:
                    ...
                    mProc.regs.EAX = (UInt32)(lEDXEAX / (Int64)Op1Value.OpDWord);
                    mProc.regs.EDX = (UInt32)(lEDXEAX % (Int64)Op1Value.OpDWord);
                    break;
                #region Instructions
                /*
            Operation
    ...
    public class IMUL : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            switch (DecodedInstruction.RealOpCode)
            {
                ...
                #region 0xF7
                case 0xF7:
                    if (lOpSize16)    //DX:AX ? AX ? r/m word 
                    {
                    ...
                    else                    //EDX:EAX ? EAX ? r/m doubleword
                    {
                        ...
                        mOp2_32 = (Int32)Op1Value.OpDWord;
                ...
                #region 0x0FAF
                case 0x0FAF:
                    if (lOpSize16)    //IMUL r16,r/m16 word register ? word register ? r/m word
                    {
                        ...
                        mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (UInt16)mOp1_16);
                    ...
                    else                    //IMUL r32,r/m32 doubleword register ? doubleword register ? r/m doubleword
                    {
                       ...
                       mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (UInt32)mOp1_32);
                ...
                case 0x6B:
                    ...
                    {
                        if (lOpSize16)    //IMUL r16,r/m16,imm8 word register ? r/m16 ? sign-extended immediate byte
                        {
                    ...
                    {
                        if (lOpSize16)    //IMUL r16,imm8 word register ? word register ? sign-extended immediate byte
                        {
                            mOp1_16 = (Int16)Op1Value.OpWord;
                ...
                #region 0x69
                case 0x69:
                    if (Op3Value.OpDWord != 0xFFFFFFFF)
                    {
                        if (lOpSize16)    //IMUL r16,r/m16,imm16 word register ? r/m16 ? immediate word
                        {
                            mOp1_16 = (Int16)lOp2Value.OpWord;
                    ...
                    {
                        if (lOpSize16)    //word register ? r/m16 ? immediate word
                        {
                            mOp1_16 = (Int16)Op1Value.OpWord;
                            mOp2_16 = (Int16)lOp2Value.OpWord;
                            mTemp_32 = (Int32)(mOp1_16 * mOp2_16);
    ...
    public class IN : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case TypeCode.Byte:
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, (byte)mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
                case TypeCode.UInt16:
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (UInt16)mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
                case TypeCode.UInt32:
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.ports.In(Op2Value.OpWord, Op1TypeCode));
                    break;
            }
        }
    }
    public class INVLPG : Instruct
    {
        ...
        public override void Impl()
        {
            DWord lMemAddr = Op1Add;
            if (mProc.regs.CPL != 0)
            {
                //If not CPL = 0 then 
                DecodedInstruction.ExceptionNumber = 0x0D;
                DecodedInstruction.ExceptionThrown = true;
                DecodedInstruction.ExceptionAddress = DecodedInstruction.InstructionAddress;
                DecodedInstruction.ExceptionErrorCode = 0;
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    Op2Value.OpByte = 0x1;
                    mProc.regs.setFlagSF(lOp1Value.OpByte);
                    mProc.regs.setFlagOF_Add(lOp1Value.OpByte, Op2Value.OpByte, Op1Value.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1Value.OpWord++;
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpWord);
                    Op2Value.OpWord = 0x1;
                    mProc.regs.setFlagSF(lOp1Value.OpWord);
                    mProc.regs.setFlagOF_Add(lOp1Value.OpWord, Op2Value.OpWord, Op1Value.OpWord);
                    break;
                case TypeCode.UInt32:
                    lOp1Value.OpDWord++;
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpDWord);
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpDWord);
                    mProc.regs.setFlagOF_Add(lOp1Value.OpDWord, Op2Value.OpDWord, Op1Value.OpDWord);
                    break;
                case TypeCode.UInt64:
                    lOp1Value.OpQWord++;
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, lOp1Value.OpQWord);
                    ...
                    mProc.regs.setFlagSF(lOp1Value.OpQWord);
                    mProc.regs.setFlagOF_Add(lOp1Value.OpQWord, Op2Value.OpQWord, Op1Value.OpQWord);
                    break;
            }
        ...
        public override void Impl()
        {
            ...
            do
            {
                if (DecodedInstruction.RealOpCode == 0x6c)
                {
                    ...
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, lDest, (byte)mProc.ports.In(mProc.regs.DX, TypeCode.Byte));
                    if (DecodedInstruction.ExceptionThrown) return;
                    MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 1, false, true, false, false);
                ...
                else
                {
                    if (mProc.OpSize16)
                    {
                        if (mProc.AddrSize16)
                            ...
                            lDest = PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI);
                        mProc.mem.SetWord(mProc, ref DecodedInstruction, lDest, (Word)mProc.ports.In(mProc.regs.DX, TypeCode.UInt16));
                        if (DecodedInstruction.ExceptionThrown) return;
                        MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 2, false, true, false, false);
                    }
                    else
                    {
                        if (mProc.AddrSize16)
                            ...
                            lDest = PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI);
                       mProc.mem.SetDWord(mProc, ref DecodedInstruction, lDest, mProc.ports.In(mProc.regs.DX, TypeCode.UInt32));
                        if (DecodedInstruction.ExceptionThrown) return;
                        MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 4, false, true, false, false);
                    }
                }
    ...
    public class INT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //int a = 0;
            //if (Op1Value.OpWord == 0x80 && mProc.regs.CR2 == 0x6001D5F0)
            //    a = a + 1 - 5 + 6;
            ...
            lPush.DecodedInstruction = DecodedInstruction;
            lPush.DecodedInstruction.ExceptionThrown = false; 
            lPush.Operand1IsRef = false;
            if (mProc.OperatingMode != ProcessorMode.Protected)
            ...
            switch (mProc.OperatingMode)
            {
                case ProcessorMode.Real:
                    ...
                    lPush.Op1Add = 0x0;
                    mProc.regs.CS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, (Op1Value.OpDWord * 4 + 2));
                    mProc.regs.IP = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op1Value.OpDWord * 4);
                    break;
                ...
                default:    //protected or virtual mode
                    ...
                    {   //#GP((DEST ? 8) + 2 + EXT)");
                        ...
                        DecodedInstruction.ExceptionThrown = true;
                        DecodedInstruction.ExceptionAddress = DecodedInstruction.InstructionAddress;
                        DecodedInstruction.ExceptionErrorCode = Op1Value.OpDWord; // *8 + 2; 08/18/2013 - CLR - don't seem to need to encode the error code
                        DecodedInstruction.ExceptionNumber = 0x0d;
                        return;
                    }

                    lIDT = mProc.mIDTCache[Op1Value.OpWord];
                    if ((lIDT.Descriptor_PL < mProc.regs.CPL) && (!DecodedInstruction.ExceptionThrown) && (!mProc.ServicingIRQ))
                    ...
                    {   //#GP((vector_number ? 8) + 2 + EXT)");
                        ...
                        DecodedInstruction.ExceptionThrown = true;
                        DecodedInstruction.ExceptionAddress = DecodedInstruction.InstructionAddress;
                        DecodedInstruction.ExceptionErrorCode = Op1Value.OpDWord * 8 + 2;
                        return;
                    }
                    ...
                    {   //TRAP-OR-INTERRUPT-GATE (* PE=1, trap/interrupt gate *)
                        ...
                        if ((lGDT.access.SegType != eGDTSegType.Code_Exec_Only_Conforming
                            ...
                            if ((mProc.regs.EFLAGS & 0x20000) != 0X20000)
                            {
                                ...
                                if (DecodedInstruction.ExceptionThrown)
                                {
                                    lPush.Op1Add = Processor_80x86.RCS; lPush.Impl(); lPush.Op1Add = 0x0;
                                    ...
                                    lPush.Op1Value.OpDWord = DecodedInstruction.ExceptionErrorCode;
                                    lPush.Impl();
                                    if (mProc.OpSize16)
                                    {
                                ...
                                DecodedInstruction.ExceptionNumber = Global.CPU_NO_EXCEPTION;
                            ...
                            //(* code segment, DPL<CPL, VM=0 *)
                                ...
                                else    //INTERRUPT-FROM-VIRTUAL-8086-MODE;
                                {
                                    ...
                                    if (mProc.mIDTCache[Op1Value.OpWord].GateType == eSystemOrGateDescType.Interrupt_Gate_32)
                                        lPush.mOverrideAddrSizeFor32BitGate = true;
                                    ...
                                    lPush.Op1Add = 0x00;
                                    lPush.Op1Value.OpDWord = mProc.regs.GS.mRealModeValue; lPush.Impl();
                                    if (lPush.DecodedInstruction.ExceptionThrown)
                                    {
                                        DecodedInstruction = lPush.DecodedInstruction;
                                        return;
                                    }
                                    lPush.Op1Value.OpDWord = mProc.regs.FS.mRealModeValue; lPush.Impl();
                                    lPush.Op1Value.OpDWord = mProc.regs.DS.mRealModeValue; lPush.Impl();
                                    lPush.Op1Value.OpDWord = mProc.regs.ES.mRealModeValue; lPush.Impl();
                                    /*lPush.Op1Add = Processor_80x86.RSS;*/
                                    lPush.Op1Value.OpDWord = lTempSS; lPush.Impl();
                                    /*lPush.Op1Add = Processor_80x86.RESP;  CLR 07/10/2013 - remarked out this and RSS above*/
                                    lPush.Op1Value.OpDWord = lTempESP; lPush.Impl();
                                    lPush.Op1Add = 0;
                                    ...
                                    if (DecodedInstruction.ExceptionThrown || Op1Value.OpWord == 0x14)
                                    {
                                        ...
                                        //else
                                        lPush.Op1Value.OpDWord = (DecodedInstruction.ExceptionErrorCode * 8) + 2;
                                        lPush.Impl();
                                        if (mProc.OpSize16 && !lPush.mOverrideAddrSizeFor32BitGate)
                                        {
                                            lPush.Op1Value.OpDWord = 0;
                                            lPush.Impl();
                                        }
                                    }
                                    else
                                    ...
                                    lPush.mOverrideAddrSizeFor32BitGate = false;
                            ...
                            //throw new Exception("Code #GP(new code segment selector)");
                            {
                                ...
                                DecodedInstruction.ExceptionThrown = true;
                                DecodedInstruction.ExceptionAddress = DecodedInstruction.InstructionAddress;
                                DecodedInstruction.ExceptionErrorCode = lIDT.SegSelector;
                                return;
                            }
    ...
    public class IRET : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (mProc.OperatingMode == ProcessorMode.Real)
            {
                ...
                lPop.Op1Add = Processor_80x86.RIP;
                lPop.Impl();

                lPop.Op1Add = Processor_80x86.RCS;
                lPop.Impl();
                lPop.Op1Add = 0x0;
                ...
                lPopF.DecodedInstruction = DecodedInstruction;
                lPopF.Op1Add = 0x0;
                lPopF.Impl();

                //lPop.Op1Add = Processor_80x86.RFL;
                //lPop.Impl();
            ...
            {   //RETURN-FROM-VIRTUAL-8086-MODE
                if (mProc.OperatingMode == ProcessorMode.Virtual8086)
                {
                    if (mProc.OpSize16)
                    {
                        ...
                        lPop.Impl();
                        if (lPop.DecodedInstruction.ExceptionThrown)
                        {
                            DecodedInstruction = lPop.DecodedInstruction;
                            return;
                        }
                ...
                else
                {
                    ...
                    else    //PROTECTED-MODE-RETURN
                    {
                        if (mProc.mGDTCache[(int)lTempCS >> 3].access.PrivLvl > mProc.regs.CPL)
                        {
                            ...
                            //lPop.Op1Add = Processor_80x86.RESP;
                            lPop.Op1Add = 0;
                            lPop.Impl();
                            if (lPop.DecodedInstruction.ExceptionThrown)
                            {
    ...
    public class JA : Instruct
    {
        public JA()
        {
            ...
            mProcPentium = true;
            mProcPentiumPro = true;
            mFlowNonReturningInstruction = true;
            ...
            if (Operand1IsRef)
            {
                ...
                switch (Op1TypeCode)
                {
                    ...
                    case TypeCode.UInt32:
                        ...
                        {
                            if (lOpSize16 && mProc.AddrSize16 && mProc.mCurrentInstruction.DecodedInstruction.OpCode != 0xE8)
                            {
                                mProc.regs.CS.Value = PhysicalMem.GetSegForLoc(mProc, Op1Value.OpDWord);
                                mProc.regs.EIP = PhysicalMem.GetOfsForLoc(mProc, Op1Value.OpDWord);
                            }
    ...
    public class JMPF : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if ((DecodedInstruction.OpCode == 0xFF05 || DecodedInstruction.OpCode == 0xEA) && mProc.OperatingMode == ProcessorMode.Protected)
            {
                ...
                mProc.mCurrTSS.Commit(mProc, ref DecodedInstruction);
                ...
                DWord lTempCR3 = mProc.mem.GetDWord(mProc, ref DecodedInstruction, theDescriptor.Base + 28);
                ...
                LTR.Load(mProc, ref DecodedInstruction);
                ...
                LLDT.Load(mProc, ref DecodedInstruction);
            ...
            if (mProc.OperatingMode == ProcessorMode.Protected)
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Processor_80x86.RCS, PhysicalMem.GetSegForLoc(mProc, (UInt32)Op2Value.OpWord));
            else
    ...
    public class LAR : Instruct
    {
        ...
        public override void Impl()
        {
            if (lOpSize16)
            {
                Op1Value.OpWord = (Word)(Op2Value.OpWord & 0xFF00);
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Op1Value.OpWord);
            }
            else
            {
                Op1Value.OpDWord = Op2Value.OpDWord & 0x00f0ff00;
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op1Value.OpDWord);
            }
        }
    }
    ...
    public class LEA : Instruct
    {
        ...
        {
            if (lOpSize16)
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (Word)Op2Add);
            else
                if (mProc.AddrSize16)
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (Word)Op2Add);
                else
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op2Add);
        }
    }
    public class LEAVE : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (lOpSize16)
            {
                ...
                lPop.Op1Add = Processor_80x86.RBP;
                lPop.Operand1IsRef = true;
                lPop.Impl();
            }
            else
            {
                ...
                lPop.Op1Add = Processor_80x86.REBP;
                lPop.Operand1IsRef = true;
                lPop.Impl();
    ...
    public class LDS : Instruct
    {
        ...
        public override void Impl()
        {
            if (lOpSize16)
            {
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.DS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 2);
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.DS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 4);
            }
        }
    }
    public class LES : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.ES.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 2);
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.ES.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 4);
            }
            #region Instructions
            #endregion
        }
    ...
    public class LFS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.FS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 2);
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.FS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 4);
            }
        }
    }
    public class LGS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.GS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 2);
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.GS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 4);
            }
        }
    }
    public class LGDT : Instruct
    {
        ...
        public override void Impl()
        {
            //if (DecodedInstruction.InstructionAddress == 0xF41ac)
            //    System.Diagnostics.Debug.WriteLine("LGDT - " + Op1Value.OpQWord.ToString("X16"));
            if (Op1Value.OpQWord != mProc.regs.GDTR.mOriginalValue)
            {
                Boolean PFException = false;
                mProc.regs.GDTR.Parse(mProc, Op1Value.OpQWord);
                if (mProc.OperatingMode != ProcessorMode.Real)
                    mProc.regs.GDTR.mBase = mProc.mem.PagedMemoryAddress(mProc, ref DecodedInstruction, mProc.regs.GDTR.Base, false);
                if (PFException)
                    return;
                //if (mProc.regs.GDTR.mBase == 0x0013a380)
                //    a = a + a - a;
            }
            mProc.RefreshGDTCache();
    ...
    public class LIDT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (Op1Value.OpQWord != mProc.regs.IDTR.mOriginalValue)
            {
                ...
                if (mProc.OperatingMode != ProcessorMode.Real)
                    mProc.regs.IDTR.mBase = mProc.mem.PagedMemoryAddress(mProc, ref DecodedInstruction, mProc.regs.IDTR.Base, false);
                if (PFException)
                    return;
            }
            mProc.RefreshIDTCache();
    ...
    public class LLDT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            Load(mProc, ref DecodedInstruction);
            #region Instructions
            #endregion
        }
    }
    ...
    public class LODSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            MOVSW.SetupMOVSSrcDest(mProc, ref lSource, ref lJunk, mProc.AddrSize16);
            do
            {
                mProc.regs.AL = mProc.mem.GetByte(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 1, true, false, true, false);
                if (DecodedInstruction.ExceptionThrown)
                    return;
    ...
    public class LODSW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!lOpSize16)
            {
                Instruct lLODSD = mProc.Instructions["LODSD"];
                lLODSD.DecodedInstruction = DecodedInstruction;
                lLODSD.Impl();
                DecodedInstruction = lLODSD.DecodedInstruction;
                return;
            }
            ...
            do
            {
                mProc.regs.AX = mProc.mem.GetWord(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 2, true, false, true, false);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                if ((mProc.mRepeatCondition == Processor_80x86.NOT_REPEAT) || (mProc.NeedToInterruptLoop() && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT))
                    return;
    ...
    public class LODSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            do
            {
                mProc.regs.EAX = mProc.mem.GetDWord(mProc, ref DecodedInstruction, lSource);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 4, true, false, true, false);
                if ((mProc.mRepeatCondition == Processor_80x86.NOT_REPEAT) || (mProc.NeedToInterruptLoop() && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT))
                    return;
            }
            while (--lLoopCounter > 0 && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT);
    ...
    public class LOOPZ : Instruct
    {
        ...
        public override void Impl()
        {
            Instruct lLOOPE = mProc.Instructions["LOOPE"];
            lLOOPE.ChosenOpCode = ChosenOpCode;
            lLOOPE.DecodedInstruction = DecodedInstruction;
            lLOOPE.Op1Value = Op1Value;
            lLOOPE.Op1TypeCode = Op1TypeCode;
            lLOOPE.Operand1IsRef = Operand1IsRef;
            lLOOPE.Impl();
            DecodedInstruction = lLOOPE.DecodedInstruction;
        }
    }
    public class LOOPNE : Instruct
    {
        ...
        public void LoopNE_Logic(Processor_80x86 mProc)
        {
            if (mProc.AddrSize16)
            {
                if ((--mProc.regs.CX != 0) && (!mProc.regs.FLAGSB.ZF))
    ...
    public class LOOPNZ : Instruct
    {
        ...
        public override void Impl()
        {
            mProc.LOOPNE.mProc = mProc;
            mProc.LOOPNE.Op1Value = Op1Value;
            mProc.LOOPNE.Op1TypeCode = Op1TypeCode;
            ((LOOPNE)(mProc.LOOPNE)).LoopNE_Logic(mProc);
    ...
    public class LSS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.SS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 2);
            }
            else
            {
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, mProc.mem.GetDWord(mProc, ref DecodedInstruction, Op2Add));
                mProc.regs.SS.Value = mProc.mem.GetWord(mProc, ref DecodedInstruction, Op2Add + 4);
            }
        }
    }
    ...
    public class MOV : Instruct
    {
        ...
        public override void Impl()
        {
            if ((Op2Add >= Processor_80x86.REGADDRBASE + Processor_80x86.RCSOFS) && (Op2Add <= Processor_80x86.REGADDRBASE + Processor_80x86.RSSOFS) && mProc.OperatingMode == ProcessorMode.Protected)
            {
                if (lOpSize16)
            ...
            switch (Op1TypeCode)
            {
                ...
                case TypeCode.UInt32:
                    ...
                    return;
                case TypeCode.UInt64:
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpQWord);
                    return;
                default:
    ...
    public class MOVSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            MOVSW.SetupMOVSSrc(mProc, ref lSource, mProc.AddrSize16, true);
            MOVSW.SetupMOVSDest(mProc, ref lDest, mProc.AddrSize16, false, false);

            do
            {
                //8/28/10 - Per Intel, DS can be overwritten, ES cannot, changing for this reason
                mProc.mem.SetByte(mProc, ref DecodedInstruction, lDest, mProc.mem.GetByte(mProc, ref DecodedInstruction, lSource));
    ...
    public class MOVSW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!lOpSize16)
            {
                Instruct lMOVSD = mProc.Instructions["MOVSD"];
                lMOVSD.DecodedInstruction = DecodedInstruction;
                lMOVSD.Impl();
                DecodedInstruction = lMOVSD.DecodedInstruction;
                return;
            }
            ...
            {
                //8/28/10 - Per Intel, DS can be overwritten, ES cannot, changing for this reason
                mProc.mem.SetWord(mProc, ref DecodedInstruction, lDest, mProc.mem.GetWord(mProc, ref DecodedInstruction, lSource));
        ...
        public static void SetupMOVSDest(Processor_80x86 mProc, ref DWord Dest, bool AddrSize16, bool Overrideable, bool DWordInstruction)
        {
            if (mProc.mSegmentOverride == Processor_80x86.RSS && Overrideable)
                ...
                if (AddrSize16) //CLR: This seemed to be needed for DOS but doesn't work for LINUX || (DWordInstruction==true && !AddrSize16))
                    Dest = PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.DI);
                else
                    Dest = PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI);
        }
    ...
    public class MOVSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            MOVSW.SetupMOVSSrc(mProc, ref lSource, mProc.AddrSize16, true);
            MOVSW.SetupMOVSDest(mProc, ref lDest, mProc.AddrSize16, false, true);

            do
            {
                //8/28/10 - Per Intel, DS can be overwritten, ES cannot, changing for this reason
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, lDest, mProc.mem.GetDWord(mProc, ref DecodedInstruction, lSource));
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lDest, ref lSource, mProc.AddrSize16, 4, true, true, true, false);
                if ((mProc.mRepeatCondition == Processor_80x86.NOT_REPEAT) || (mProc.NeedToInterruptLoop() && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT))
    ...
    public class MOVSX : Instruct
    {
        ...
        public override void Impl()
        {
            if (this.ChosenOpCode.OpCode == 0x0FBE)
                if (lOpSize16)
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Misc.SignExtend(Op2Value.OpByte));
                else
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Misc.SignExtend(Misc.SignExtend(Op2Value.OpByte)));
            else
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Misc.SignExtend(Op2Value.OpWord));
    ...
    public class MOVZX : Instruct
    {
        ...
        public override void Impl()
        {
            if (this.ChosenOpCode.OpCode == 0x0FB6)
                if (lOpSize16)
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpByte);
                else
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpByte);
            else
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpWord);
        ...
        public override void Impl()
        {
            ...
            switch (Op1TypeCode)
            {
                case TypeCode.Byte:
                    ...
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, lOp1Val.OpByte);
                    mProc.regs.setFlagOF_Sub(lPreVal1.OpByte, (byte)-(lOp1Val.OpByte), lOp1Val.OpByte);
                    break;
                case TypeCode.UInt16:
                    lOp1Val.OpWord = (Word)(-(lOp1Val.OpWord));
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lOp1Val.OpWord);
            ...
            SetFlagsForSubtraction(mProc, lPreVal1, Op1Value, lOp1Val, Op1TypeCode);
            #region Instructions
            #endregion
        }
    }
    ...
    public class OUT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case 0xE6:
                    mProc.ports.Out(Op1Value.OpByte, mProc.regs.AL, TypeCode.Byte);
                    return;
                case 0xE7:
                    if (lOpSize16)
                        mProc.ports.Out(Op1Value.OpByte, mProc.regs.AX, TypeCode.UInt16);
                    else
                        mProc.ports.Out(Op1Value.OpByte, mProc.regs.EAX, TypeCode.UInt32);
                    return;
                case 0xEE:
    ...
    public class OUTS : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            do
            {
                ...
                {
                    if (DecodedInstruction.ExceptionThrown) return;
                    mProc.ports.Out(Op1Value.OpByte, mProc.mem.GetByte(mProc, ref DecodedInstruction, lSource), TypeCode.Byte);
                    MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 1, true, false, false, false);
                }
                else
                {
                    if (mProc.OpSize16)
                    {
                        mProc.ports.Out(mProc.regs.DX, (Word)mProc.mem.GetWord(mProc, ref DecodedInstruction, lSource), TypeCode.UInt16);
                        MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 2, true, false, false, false);
                    }
                    else
                    {
                        mProc.ports.Out(mProc.regs.DX, (DWord)mProc.mem.GetDWord(mProc, ref DecodedInstruction, lSource), TypeCode.UInt32);
                        MOVSW.IncDec(mProc, ref lJunk, ref lSource, mProc.AddrSize16, 4, true, false, false, false);
                    }
                }
            }
            while (--lLoopCounter > 0 && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT);
    ...
    public class POP : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (lAddrSize16)
                if (lOpSize16)
                {
                    Op1Value.OpWord = mProc.mem.GetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.SP));
                    if (Op1Add != Processor_80x86.RSP) mProc.regs.SP += 2;
                }
                else
                {
                    Op1Value.OpDWord = mProc.mem.GetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.SP));
                    if (Op1Add != Processor_80x86.RSP) mProc.regs.SP += 4;
                }
            else
                if (lOpSize16)
                {
                    Op1Value.OpWord = mProc.mem.GetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.ESP));
                    if (Op1Add != Processor_80x86.RSP) mProc.regs.ESP += 2;
                }
                else
                {
                    Op1Value.OpDWord = mProc.mem.GetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.ESP));
                    if (Op1Add != Processor_80x86.RSP) mProc.regs.ESP += 4;
                }
            ...
            if (Op1Add == Processor_80x86.RSP && lOpSize16)
            {
    ...
    public class POPA : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (lOpSize16)
            {
                ...
                lPop.mInternalInstructionCall = false;
                lPop.Operand1IsRef = true;
                lPop.Op1Add = Processor_80x86.RDI; lPop.Impl();
                if (lPop.DecodedInstruction.ExceptionThrown)
                {
                    DecodedInstruction = lPop.DecodedInstruction;
                    return;
                }
                lPop.Op1Add = Processor_80x86.RSI; lPop.Impl();
                lPop.Op1Add = Processor_80x86.RBP; lPop.Impl();
                mProc.regs.SP += 2;
                lPop.Op1Add = Processor_80x86.RBX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.RDX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.RCX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.RAX; lPop.Impl();
            }
            else
            {
                lPop.DecodedInstruction = DecodedInstruction;
                lPop.mInternalInstructionCall = false;
                lPop.Op1Add = Processor_80x86.REDI; lPop.Impl();
                if (lPop.DecodedInstruction.ExceptionThrown)
                {
                    DecodedInstruction = lPop.DecodedInstruction;
                    return;
                }
                lPop.Op1Add = Processor_80x86.RESI; lPop.Impl();
                lPop.Op1Add = Processor_80x86.REBP; lPop.Impl();
                mProc.regs.SP += 4;
                lPop.Op1Add = Processor_80x86.REBX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.REDX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.RECX; lPop.Impl();
                lPop.Op1Add = Processor_80x86.REAX; lPop.Impl();
            }
        }
    }
    ...
    public class PUSH : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (mInternalInstructionCall)
                lAddrSize16 = true;
            if (mOverrideAddrSizeFor32BitGate)
            {
                lOpSize16 = false;
            }
            ...
            if (Operand1IsRef && Op1Add == Processor_80x86.RSP)  //SP & ESP have the same location
                if (lOpSize16)
                    lTemp16 = mProc.regs.SP;
                else
                    lTemp32 = mProc.regs.ESP;
            if ((Op1Add >= Processor_80x86.REGADDRBASE + Processor_80x86.RCSOFS && (Op1Add <= Processor_80x86.REGADDRBASE + Processor_80x86.RSSOFS) && (Op1Add <= Processor_80x86.REGADDRBASE + Processor_80x86.RSSOFS)) && mProc.OperatingMode == ProcessorMode.Protected)
            {
                DWord lTempT = Misc.GetSelectorForSegment(mProc, Op1Add, 0);
                if (lTempT != 0)
                {
                    if (lOpSize16)
                        lTemp16 = (UInt16)lTempT;
                    else
                        lTemp32 = lTempT;
                }
            }
            ...
            if (lAddrSize16)
            {
                ...
                if (lOpSize16)
                {
                    if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0x6a && !Operand1IsRef && Op1TypeCode == TypeCode.Byte && lTemp32 < 0x100)
                        lTemp16 = Misc.SignExtend((byte)lTemp32);
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.SP), lTemp16);
                }
                else
                {
                    if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0x6a && !Operand1IsRef && Op1TypeCode == TypeCode.Byte && lTemp32 < 0x100)
                        lTemp32 = Misc.SignExtend((Word)Misc.SignExtend((byte)lTemp32));
                    else if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0x6a && !Operand1IsRef && Op1TypeCode == TypeCode.UInt16 && lTemp32 < 0x10000)
                        lTemp32 = Misc.SignExtend((Word)lTemp32);
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.SP), lTemp32);
                }
            }
            else
            {
                if (lOpSize16)
                {
                    //CLR 07/14/2003 - Removed this and the next one because DOS with EMM386 doesn't like them!
                    if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0x6a && !Operand1IsRef && Op1TypeCode == TypeCode.Byte && lTemp32 < 0x100)
                        lTemp16 = Misc.SignExtend((byte)lTemp32);
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.ESP), lTemp16);
                }
                else
                {
                    if (mProc.mCurrentInstruction.DecodedInstruction.OpCode == 0x6a && !Operand1IsRef && Op1TypeCode == TypeCode.Byte && lTemp32 < 0x100)
                        ...
                        lTemp32 = Misc.SignExtend((Word)lTemp32);
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.SS, mProc.regs.ESP), lTemp32);
                }
            }
    ...
    public class REPE : Instruct
    {
        ...
        public override void Impl()
        {
            Instruct lREPZ = mProc.Instructions["REPZ"];
            lREPZ.DecodedInstruction = DecodedInstruction;
            lREPZ.Impl();
            DecodedInstruction = lREPZ.DecodedInstruction;
                #region Instructions
            #endregion
        }
    }
    ...
    public class REPNZ : Instruct
    {
        ...
        public override void Impl()
        {
            Instruct lREPNE = mProc.Instructions["REPNE"];
            lREPNE.DecodedInstruction = DecodedInstruction;
            lREPNE.Impl();
            DecodedInstruction = lREPNE.DecodedInstruction;
                #region Instructions
            #endregion
        }
    }
    ...
    public class RET : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                lPop.mProc = mProc;
                lPop.Op1Add = Processor_80x86.REIP;
                lPop.Impl();
            }
            if (lPop.DecodedInstruction.ExceptionThrown)
            {
    ...
    public class SAL : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            lSHL.DecodedInstruction = DecodedInstruction;
            ...
            lSHL.Impl();
            DecodedInstruction = lSHL.DecodedInstruction;
            #region Instructions
            #endregion
        }
    }
    ...
    public class SAR : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (Op1Value.OpDWord >= 0x80000000)
    ...
    public class SBB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //Set the flags
            SetFlagsForSubtraction(mProc, lPreVal1, lOp2Value, lOp1ValSigned, Op1TypeCode);
    ...
    public class SCASB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            sOpVal lTemp;
            if (mProc.AddrSize16)
                lTemp = new sOpVal(mProc.mem.GetByte(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.DI)));
            else
                lTemp = new sOpVal(mProc.mem.GetByte(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI)));
            if (DecodedInstruction.ExceptionThrown) return;
            sOpVal lAL = lPreVal1;
            ...
            //notice that we don't save the result, we just use it to save the flags
            SetFlagsForSubtraction(mProc, lPreVal1, lTemp, lAL, TypeCode.Byte);
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpByte, lAL.OpByte, lTemp.OpByte);
            if (mProc.regs.FLAGSB.DF)
            {
                if (mProc.AddrSize16)
                    mProc.regs.DI--;
    ...
    public class SCASD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            sOpVal lPreVal1 = new sOpVal(mProc.regs.EAX);
            ...
            sOpVal lTemp;
            if (mProc.AddrSize16)
                lTemp = new sOpVal(mProc.mem.GetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.DI)));
            else
                lTemp = new sOpVal(mProc.mem.GetDWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI)));
            if (DecodedInstruction.ExceptionThrown) return;
            sOpVal lAL = lPreVal1;
            ...
            //notice that we don't save the result, we just use it to save the flags
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpDWord, lAL.OpDWord, lTemp.OpDWord);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpDWord, lTemp.OpDWord, lAL.OpDWord);
    ...
    public class SCASW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!lOpSize16)
            {
                Instruct lSCASD = mProc.Instructions["SCASD"];
                lSCASD.DecodedInstruction = DecodedInstruction;
                lSCASD.Impl();
                DecodedInstruction = lSCASD.DecodedInstruction;
                return;
            }

            sOpVal lTemp;
            if (mProc.AddrSize16)
                lTemp = new sOpVal(mProc.mem.GetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.DI)));
            else
                lTemp = new sOpVal(mProc.mem.GetWord(mProc, ref DecodedInstruction, PhysicalMem.GetLocForSegOfs(mProc, ref mProc.regs.ES, mProc.regs.EDI)));
            if (DecodedInstruction.ExceptionThrown) return;
            sOpVal lAL = lPreVal1;
            ...
            mProc.regs.setFlagCF_SUB_CMP(lPreVal1.OpWord, lAL.OpWord, lTemp.OpWord);
            mProc.regs.setFlagOF_Sub(lPreVal1.OpWord, lTemp.OpWord, lAL.OpWord);
    ...
    public class SETcc : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, lOp1Value);
    ...
    public class SHRD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case TypeCode.Byte:
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, Dest.OpByte);
                    mProc.regs.setFlagSF(Dest.OpByte);
                    break;
                case TypeCode.UInt16:
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Dest.OpWord);
                    mProc.regs.setFlagSF(Dest.OpWord);
                    break;
                case TypeCode.UInt32:
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Dest.OpDWord);
                    mProc.regs.setFlagSF(Dest.OpDWord);
                    break;
                case TypeCode.UInt64:
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, Dest.OpQWord);
    ...
    public class SIDT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, lLimit);
           mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add + 4, lBase);
    ...
    public class SMSW : Instruct
    {
        ...
        public override void Impl()
        {
            if (DecodedInstruction.Op1.Register != eGeneralRegister.NONE)
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (mProc.regs.CR0 & 0xFFFF));
            else
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (Word)mProc.regs.CR0);
            #region Instructions
            #endregion
        }
    }
    ...
    public class STR : Instruct
    {
        ...
        {
            if (DecodedInstruction.Op1.Register != eGeneralRegister.NONE)
               mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, (DWord)(mProc.regs.TR.SegSel & 0xFFFF));
            else
                mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, (Word)mProc.regs.TR.SegSel);
    ...
    public class STOSB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            do
            {
                ...
                mProc.mem.SetByte(mProc, ref DecodedInstruction, lDest, mProc.regs.AL);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 1, false, true, false, false);
                if ((mProc.mRepeatCondition == Processor_80x86.NOT_REPEAT) || (mProc.NeedToInterruptLoop() && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT))
    ...
    public class STOSW : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            if (!lOpSize16)
            {
                Instruct lSTOSD = mProc.Instructions["STOSD"];
                lSTOSD.DecodedInstruction = DecodedInstruction;
                lSTOSD.Impl();
                DecodedInstruction = lSTOSD.DecodedInstruction;
                return;
            }
            ...
            do
            {
                ...
                mProc.mem.SetWord(mProc, ref DecodedInstruction, lDest, mProc.regs.AX);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 2, false, true, false, false);
                if (DecodedInstruction.ExceptionThrown)
    ...
    public class STOSD : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            //MOVSW.SetupMOVSSrcDest(mProc, ref lJunk, ref lDest, mProc.AddrSize16);
            do
            {

               mProc.mem.SetDWord(mProc, ref DecodedInstruction, lDest, mProc.regs.EAX);
                if (DecodedInstruction.ExceptionThrown)
                    return;
                MOVSW.IncDec(mProc, ref lDest, ref lJunk, mProc.AddrSize16, 4, false, true, false, false);
                if ((mProc.mRepeatCondition == Processor_80x86.NOT_REPEAT) || (mProc.NeedToInterruptLoop() && mProc.mRepeatCondition != Processor_80x86.NOT_REPEAT))
    ...
    public class XADD : Instruct
    {
        ...
        public override void Impl()
        {
            Instruct lAdd = mProc.Instructions["ADD"];
            lAdd.DecodedInstruction = DecodedInstruction;
            lAdd.Op1TypeCode = Op2TypeCode;
            lAdd.Op2TypeCode = Op1TypeCode;
            lAdd.Operand1IsRef = Operand2IsRef;
            lAdd.Operand2IsRef = Operand1IsRef;
            lAdd.Op1Value = Op2Value;
            lAdd.Op1Add = Op2Add;
            lAdd.Op2Value = Op1Value;
            lAdd.Op2Add = Op1Add;
            lAdd.Impl();
            DecodedInstruction = lAdd.DecodedInstruction;
        }
    }
    public class XCHG : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            {
                case TypeCode.Byte:
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op2Add, Op1Value.OpByte);
                    mProc.mem.SetByte(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpByte);
                    return;
                case TypeCode.UInt16:
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op2Add, Op1Value.OpWord);
                    mProc.mem.SetWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpWord);
                    return;
                case TypeCode.UInt32:
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op2Add, Op1Value.OpDWord);
                   mProc.mem.SetDWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpDWord);
                    return;
                case TypeCode.UInt64:
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op2Add, Op1Value.OpQWord);
                    mProc.mem.SetQWord(mProc, ref DecodedInstruction, Op1Add, Op2Value.OpQWord);
                    return;
            }
    ...
    public class XLAT : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.regs.AL = mProc.mem.GetByte(mProc, ref DecodedInstruction, loc);
            #region Instructions
            #endregion
        }
    }
    public class XLATB : Instruct
    {
        ...
        public override void Impl()
        {
            ...
            mProc.regs.AL = mProc.mem.GetByte(mProc, ref DecodedInstruction, TableBase + mProc.regs.AL);
